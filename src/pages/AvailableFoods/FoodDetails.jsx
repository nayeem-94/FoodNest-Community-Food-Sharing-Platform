...
const FoodDetails = () => {
    ...
    return (
        <section className="relative bg-yellow-50 overflow-hidden py-15">
            ...
            <div className=" relative max-w-5xl z-10  mx-auto">

                <div className="bg-white z-10 border border-amber-100 rounded-3xl overflow-hidden shadow-sm grid grid-cols-1 lg:grid-cols-2">

                    {/* ── Left: Image*/}
                    <div className="relative  h-auto  overflow-hidden min-h-80">
                        <img
                            src={food.image}
                            alt={food.foodname}
                    ...
                    <div className="p-8 lg:p-10 flex flex-col gap-5">
                        ...
                        <div className="flex items-center gap-3 bg-amber-50 border border-amber-100 rounded-2xl p-4">
                            ...
                            <div className="min-w-0">
                                ...
                                <p className="text-sm font-bold text-gray-900 mt-0.5 truncate">{food?.username || 'Anonymous'}</p>
                                <p className="text-xs text-gray-400 truncate">{food?.useremail}</p>
                            </div>
                        </div>
                        ...
                        <button
                            ...
                            disabled={requesting}
                            className="mt-auto w-full bg-amber-500 hover:bg-amber-600 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold text-sm rounded-2xl py-4 transition-all hover:-translate-y-0.5 active:scale-95 cursor-pointer shadow-md shadow-amber-100 tracking-wide"
                        >
                            {requesting ? (
